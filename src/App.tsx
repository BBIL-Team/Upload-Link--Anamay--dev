  ...
  return (
    ...
    <div>
      <header style={{ width: '100%' }}>
                <img style={{ padding: '10px', width: '15%', height: '15%', objectFit: 'cover', objectPosition: '50% 50%',}} src="https://media.licdn.com/dms/image/v2/C560BAQFim2B73E6nkA/company-logo_200_200/company-logo_200_200/0/1644228681907/anamaybiotech_logo?e=2147483647&v=beta&t=RnXx4q1rMdk6bI5vKLGU6_rtJuF0hh_1ycTPmWxgZDo" alt="Company Logo" className="logo" />
